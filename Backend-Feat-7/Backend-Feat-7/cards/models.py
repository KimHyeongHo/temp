...
class Card(models.Model):
    # [설명] 사용자가 등록한 카드 정보 (카드명, 발급사, 연회비, 혜택 등)
    user = models.ForeignKey('users.User', on_delete=models.CASCADE, null=True, blank=True, to_field='user_id', db_column='user_id')  # [설명] 카드 소유자 (null 허용: 시스템 카드 상품도 존재 가능)
